...
def parse_args():
    ...
    parser.add_argument('--data_path', default='../EgoPAT3D/Dataset', help='The path of the dataset')
    parser.add_argument('--model_name', default=['baseline_rgb_SinePE'], help='Model name')
...
def main(args):
    ...
    print(all_models_2b_eval)    
    print(args.model_name)                                                                                 # note that here I did the trick to get the folder name, not the (relative path)
